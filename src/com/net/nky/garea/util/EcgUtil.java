...
/**
 * General is to pressI II III aVR aVL aVF V1 V2 V3 V4 V5 V6Order display
 * To you is12Guided data  You need to get this12Pilot data reduction into a waveform display，Is generally the order of vertical arrangement
 * 
 * 12Lead logic Or is it like this  
 * But this way shows  Do not dare to compliment 
 * I used to butt in on someone else's ECG.  All get12Lead data   By code Draw their own graphics  
 * @author Ken
...
public class EcgUtil {
    ...
    public static String getResultText(int code) {
		...
		case -1:
			return null;
		case 0:
			return "Arrhythmia,Conduction block,Myocardial Infarction,ST & Tabnormal,Ventricular Hypertrophy,Atrial Hypertrophy,Abnormal Cardiac Electric Axis";
		case 1100:
			return "Sinus Rhythm";
		case 1120:
    ...
    public static String getCode(String result) {
    	...
    	if(result.equals("Arrhythmia,Conduction block,Myocardial Infarction,ST & Tabnormal,Ventricular Hypertrophy,Atrial Hypertrophy,Abnormal Cardiac Electric Axis")){
    		return "0";
